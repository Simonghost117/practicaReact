...
const Footer = () => {
    const  estiloLi="text-gray-600 hover:text-gray-800"
      ...
      <div className="flex flex-wrap md:text-left text-center order-first">
        <div className="lg:w-1/4 md:w-1/2 w-full px-4">
          ...
          <nav className="list-none mb-10">
            <li>
              <a className={estiloLi}>First Link</a>
            </li>
            <li>
              <a className={estiloLi}>Second Link</a>
            </li>
            <li>
              <a className={estiloLi}>Third Link</a>
            </li>
            <li>
              <a className={estiloLi}>Fourth Link</a>
            </li>
          </nav>
        </div>
        <div className="lg:w-1/4 md:w-1/2 w-full px-4">
